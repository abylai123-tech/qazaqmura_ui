                    ...
                    <v-col cols="6">
                        ...
                        <div class="d-flex flex-column">
                          ...
                          <div>
                            <small class="font-weight-bold">
                              {{ String((456 / 993) * 100).substring(0, 5) }}% </small
                            ><br />
                      ...
                      <div class="my-6">
                        ...
                        <div class="d-flex flex-column">
                          ...
                          <div>
                            <small class="font-weight-bold">
                              {{ String((150 / 993) * 100).substring(0, 5) }}% </small
                            ><br />
                      ...
                      <div>
                        ...
                        <div class="d-flex flex-column">
                          ...
                          <div>
                            <small class="font-weight-bold">
                              {{ String((10 / 993) * 100).substring(0, 5) }}% </small
                            ><br />
                    ...
                    <v-col cols="6">
                      <div>
                        ...
                        <div class="d-flex flex-column">
                          ...
                          <div>
                            <small class="font-weight-bold">
                              {{ String((120 / 993) * 100).substring(0, 5) }}% </small
                            ><br />
                      ...
                      <div class="my-6">
                        ...
                        <div class="d-flex flex-column">
                          ...
                          <div>
                            <small class="font-weight-bold">
                              {{ String((210 / 993) * 100).substring(0, 5) }}% </small
                            ><br />
                      ...
                      <div>
                        ...
                        <div class="d-flex flex-column">
                          ...
                          <div>
                            <small class="font-weight-bold">
                              {{ String((47 / 993) * 100).substring(0, 5) }}% </small
                            ><br />
